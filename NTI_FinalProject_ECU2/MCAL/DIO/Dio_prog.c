...
/******************************************
  syntax : Dio_LevelType M_DIO_enGetPinValue(Dio_ChannelType ChannelId);
...
/******************************************
  syntax : void M_DIO_voidSetPinValue(Dio_ChannelType ChannelId,Dio_LevelType Level);
...
/******************************************
  syntax : Dio_PortLevelType M_DIO_enGetPortValue(Dio_PortType PortId);
...
/******************************************
  syntax : void M_DIO_voidSetPortValue(Dio_PortType PortId,Dio_PortLevelType Level);
...
/******************************************
  syntax : void M_DIO_voidTogglePin(Dio_ChannelType channelId);
